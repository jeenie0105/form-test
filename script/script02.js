...
num = 20; // 20.0
let tel1 = "010-1234-1234"; // 기본 문자, 계산되지 않는 숫자
let tel2 = '010-1234-1234'; // "", '' 로 묶어서 표현

// template literal(임시 문자열) : `(백틱) 문자열
...
let ano;
console.log(ano); // undefined : 값을 저장하지 않았다. 혹은 정의되지 않음 // 연산 처리를 못함
let nullData = null;
